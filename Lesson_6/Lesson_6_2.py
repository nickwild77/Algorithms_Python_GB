...
def show_size_of_list_and_tuple():
    ...
    summ = 0
    for size in r:
        summ += sys.getsizeof(size)
    print('Размер всех элементов массива', summ)


show_size_of_list_and_tuple()


# Размер массива больше, чем неизменяемый кортеж, с одним набором данных
